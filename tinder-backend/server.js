...
// App Config
const app = express();
const port = process.env.PORT || 5000; // port app gonna listen
const connection_url = "mongodb+srv://Rohitszx:Rohit@123atlas@testcluster1.se0ho.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
